  ...
  function renderDashboardHome() {
    ...
    return `
      <section class="hero">
        ...
        <p>Lei seca, jurisprudência, flashcards e questões comentadas — com grifos, anotações e progresso na nuvem.</p>
      ...
      <div class="lex-landing">
        <div class="landing-hero-grid">
          <section class="landing-intro">
            ...
            <p class="landing-intro-lead">Lei seca, súmulas, flashcards e questões comentadas — com grifos e anotações.</p>
