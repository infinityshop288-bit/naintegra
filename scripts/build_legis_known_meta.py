...
KNOWN: dict[str, tuple[str, str, str]] = {
    ...
    "d70235": (
        ...
        "Dispõe sobre o processo administrativo fiscal (texto vigente no Planalto nesta URL).",
        "Legislação Especial",
    ),
    ...
    "del1075": (
        "Decreto-Lei 1.075/1970 — Imissão de posse (locação)",
    ...
    "del3688": (
        ...
        "Institui a Lei das Contravenções Penais.",
        "Penal e Processual",
    ),
    ...
    "l0605": (
        ...
        "Dispõe sobre repouso semanal remunerado e pagamento em feriados.",
        "Civil e Trabalho",
    ),
    ...
    "l2889": ("Lei 2.889/1956 — Lei do Genocídio", "Define e pune o crime de genocídio.", "Penal e Processual"),
    "l4090": (
    ...
    "l5250": ("Lei 5.250/1967 — Lei de Imprensa", "Regula direito de resposta e responsabilidade na imprensa.", "Constituição e Adm."),
    "l5256": ("Lei 5.256/1967 — Prisão especial", "Regula prisão especial de autoridades e agentes públicos.", "Penal e Processual"),
    "l5474": ("Lei 5.474/1968 — Lei das Duplicatas", "Dispõe sobre a emissão, circulação e cobrança de duplicatas.", "Legislação Especial"),
    "l5478": ("Lei 5.478/1968 — Lei de Alimentos", "Dispõe sobre a ação de alimentos e dá outras providências.", "Civil e Trabalho"),
    ...
    "l7492": ("Lei 7.492/1986 — Lei do Colarinho Branco", "Define crimes contra o sistema financeiro nacional.", "Penal e Processual"),
    ...
    "l8971": (
        "Lei 8.971/1994 — Companheiros (alimentos e sucessão)",
        "Regula o direito dos companheiros a alimentos e à sucessão (Lei dos Companheiros).",
        "Civil e Trabalho",
    ),
    ...
    "l10216": ("Lei 10.216/2001 — Reforma Psiquiátrica", "Dispõe sobre a proteção e os direitos das pessoas portadoras de transtornos mentais.", "Legislação Especial"),
    ...
    "l12288": ("Lei 12.288/2010 — Estatuto da Igualdade Racial", "Institui o Estatuto da Igualdade Racial e mecanismos de combate ao racismo.", "Legislação Especial"),
    "l7853": ("Lei 7.853/1989 — Apoio à pessoa com deficiência", "Dispõe sobre apoio às pessoas portadoras de deficiência e normas de acessibilidade.", "Legislação Especial"),
    "l8080": ("Lei 8.080/1990 — Lei Orgânica da Saúde (SUS)", "Dispõe sobre condições para promoção, proteção e recuperação da saúde (SUS).", "Legislação Especial"),
    "l8142": ("Lei 8.142/1990 — Participação e recursos do SUS", "Dispõe sobre participação da comunidade e transferências intergovernamentais na saúde.", "Legislação Especial"),
    "l8625": ("Lei 8.625/1993 — Lei Orgânica Nacional do MP", "Dispõe sobre a organização, competências e prerrogativas do Ministério Público.", "Constituição e Adm."),
    "l11445": ("Lei 11.445/2007 — Diretrizes do saneamento básico", "Estabelece diretrizes nacionais para o saneamento básico.", "Legislação Especial"),
    "l12305": ("Lei 12.305/2010 — Política Nacional de Resíduos Sólidos", "Institui a Política Nacional de Resíduos Sólidos (PNRS).", "Legislação Especial"),
    "l13019": ("Lei 13.019/2014 — Marco Regulatório das OSC", "Estabelece regime jurídico das parcerias entre administração pública e OSC.", "Legislação Especial"),
    "l13431": ("Lei 13.431/2017 — Depoimento especial", "Dispõe sobre o depoimento especial de crianças e adolescentes vítimas ou testemunhas de violência.", "Penal e Processual"),
    "l13964": ("Lei 13.964/2019 — Pacote Anticrime", "Altera o CP e o CPP (juiz de garantias, ANPP, investigação criminal, entre outros).", "Penal e Processual"),
    "l14119": ("Lei 14.119/2021 — Pagamento por serviços ambientais", "Institui o Pagamento por Serviços Ambientais (PSA).", "Legislação Especial"),
    "l14811": ("Lei 14.811/2024 — Bullying e cyberbullying", "Tipifica crimes de bullying e cyberbullying e altera o CP.", "Penal e Processual"),
    "lcp135": ("Lei Complementar 135/2010 — Ficha Limpa", "Altera a LC 64/1990 sobre inelegibilidades (Lei da Ficha Limpa).", "Constituição e Adm."),
    "d0678": ("Decreto 678/1992 — Convenção Americana de DH", "Promulga a Convenção Americana sobre Direitos Humanos (Pacto de San José).", "Legislação Especial"),
    "d5051": ("Decreto 5.051/2004 — Convenção 169 da OIT", "Promulga a Convenção 169 da OIT sobre povos indígenas e tribais.", "Legislação Especial"),
    "d10932": ("Decreto 10.932/2022 — Convenção Interamericana contra o Racismo", "Promulga a Convenção Interamericana contra o Racismo, a Discriminação Racial e Formas Correlatas de Intolerância.", "Legislação Especial"),
    "d11129": ("Decreto 11.129/2022 — Lei Anticorrupção (regulamentação)", "Regulamenta dispositivos da Lei 12.846/2013 (Lei Anticorrupção).", "Constituição e Adm."),
    ...
    "l12694": ("Lei 12.694/2012 — Lei do Juiz sem Rosto", "Dispõe sobre julgamento colegiado em primeiro grau de crimes por organizações criminosas; altera CP e CPP.", "Penal e Processual"),
    ...
    "l14193": ("Lei 14.193/2021 — Sociedade Anônima do Futebol", "Institui a SAF e disciplina a transformação de clubes em sociedades anônimas.", "Civil e Trabalho"),
    ...
    "l14597": ("Lei 14.597/2023 — Lei Geral do Esporte", "Institui normas gerais sobre o esporte e a governança esportiva.", "Legislação Especial"),
    ...
    "l14852": ("Lei 14.852/2024 — Marco Legal dos Jogos Eletrônicos", "Cria o marco legal para a indústria de jogos eletrônicos e altera leis correlatas.", "Legislação Especial"),
    ...
    "l15272": ("Lei 15.272/2025 — Atualizações processuais penais", "Altera o CPP sobre prisão preventiva, audiência de custódia e coleta de DNA.", "Penal e Processual"),
    "l15358": ("Lei 15.358/2026 — Marco Legal do Combate ao Crime Organizado", "Institui o marco legal anticrime organizado (Lei Raul Jungmann / Antifacção).", "Penal e Processual"),
    "l15397": ("Lei 15.397/2026 — Aumento de penas (crimes patrimoniais)", "Altera o Código Penal para majorar penas de furto, roubo, estelionato e receptação.", "Penal e Processual"),
    "l4320": ("Lei 4.320/1964 — Normas Gerais de Direito Financeiro", "Estatui normas gerais de direito financeiro para orçamentos e balanços.", "Constituição e Adm."),
    "l6969": ("Lei 6.969/1973 — Estatuto do Índio", "Dispõe sobre a política indigenista e direitos das populações indígenas.", "Legislação Especial"),
    "l8397": ("Lei 8.397/1990 — Crimes de trânsito", "Altera o Código Penal e o CTB sobre crimes de trânsito.", "Penal e Processual"),
    "l8437": ("Lei 8.437/1992 — Medidas cautelares contra o Público", "Dispõe sobre medidas cautelares contra atos do Poder Público.", "Constituição e Adm."),
    "l8742": ("Lei 8.742/1993 — LOAS", "Dispõe sobre a organização da assistência social (LOAS/BPC).", "Legislação Especial"),
    "l8884": ("Lei 8.884/1994 — CADE", "Regula defesa da concorrência e estrutura do CADE.", "Legislação Especial"),
    "l9249": ("Lei 9.249/1995 — Imposto de Renda (PF)", "Dispõe sobre tributação de pessoas físicas e altera o IR.", "Legislação Especial"),
    "l9394": ("Lei 9.394/1996 — LDB", "Estabelece as diretrizes e bases da educação nacional.", "Legislação Especial"),
    "l9492": ("Lei 9.492/1997 — Protesto de títulos", "Regula o serviço de protesto de títulos.", "Legislação Especial"),
    "l9703": ("Lei 9.703/1998 — Depósitos judiciais tributários", "Dispõe sobre depósitos judiciais e extrajudiciais de tributos federais.", "Legislação Especial"),
    "l9985": ("Lei 9.985/2000 — SNUC", "Institui o Sistema Nacional de Unidades de Conservação da Natureza.", "Legislação Especial"),
    "conama237": (
        "Resolução CONAMA 237/1997 — Licenciamento ambiental",
        "Regulamenta procedimentos e critérios de licenciamento ambiental.",
        "Legislação Especial",
    ),
    "l9986": ("Lei 9.986/2000 — RH das Agências Reguladoras", "Dispõe sobre gestão de recursos humanos das agências reguladoras.", "Legislação Especial"),
    "l10035": ("Lei 10.035/2000 — Contribuições na JT", "Altera a CLT sobre execução de contribuições previdenciárias na Justiça do Trabalho.", "Civil e Trabalho"),
    "l10150": ("Lei 10.150/2000 — Novação FCVS", "Dispõe sobre novação de dívidas do Fundo de Compensação de Variações Salariais.", "Legislação Especial"),
