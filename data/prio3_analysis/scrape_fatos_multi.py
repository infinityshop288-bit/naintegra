...
KEYWORDS = {
    ...
    "KNCR11": ["KINEA RENDIMENTOS", "KINEA REND", "KNCR"],
    "MANA11": ["MANATI CAPITAL", "MANATI"],
    "RURA11": ["RIZA ARCTIUM", "ARCTIUM"],
    "RBRP11": ["RBR PROPERTIES", "RBR PROP"],
    "HGLG11": ["CSHG LOGISTICA", "HGLG", "CSHG LOG"],
    "XPML11": ["XP MALLS", "XPML"],
    "CLIN11": ["CLAVE INDICES", "CLIN11"],
    "MXRF11": ["MAXI RENDA", "MXRF"],
}
