# Google Play — ficha da loja (NaIntegra Lex)

Copie/adapte estes textos no Play Console.
...
📖 LEI SECA
Leia artigo por artigo, com navegação clara e busca por tema ou dispositivo. Marque o que já leu, grife trechos importantes e volte exatamente de onde parou — sem perder tempo procurando onde estava.

⚖️ JURISPRUDÊNCIA
Súmulas, temas repetitivos e julgados dos principais tribunais, organizados para estudo de concurso. Ideal para complementar a lei seca com a interpretação que cai na prova.

🃏 FLASHCARDS
Revise com repetição espaçada: o app prioriza o que você ainda não fixou e reforça o que está esquecendo. Crie seus próprios decks ou use os já prontos por área do direito.

❓ QUESTÕES
Banco integrado ao NaIntegra Cursos, com comentários da comunidade e filtros para treinar por tema, acerto e erro.
...
Concurseiros que precisam de base sólida em Direito Constitucional, Penal, Administrativo, Processual e legislação especial — para fiscal, tribunais, jurídico, administrativo, MP, Defensoria, advogacia pública, carreiras policiais e demais certames com prova de direito. Material pensado para quem tem pouco tempo e precisa de resultado.
...
• Funciona offline — acervo baixado no celular para estudar sem internet
• Leitura artigo a artigo, com foco no que cai em concurso
• Revisão ativa com flashcards e questões
• Narração em áudio para aproveitar cada minuto do dia
• Interface limpa, pensada para longas sessões de estudo
...
- Regenerar: `cd mobile && npm run store:assets`

## Capturas de tela
- Geradas automaticamente (1080×1920): `mobile/store-assets/generated/screenshot-*.png`
- Mínimo 2 na Play Console; recomendado 4 (já geradas: Início, Lei Seca, Flashcards, Jurisprudência)

## Classificação de conteúdo
Público geral / sem conteúdo sensível (conteúdo jurídico-educacional)
